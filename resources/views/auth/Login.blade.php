...
<head>
   ...
   <title>Login - Admin Sinarmetrindo</title>
   ...
   <div class="container">
      <div class="row align-items-center">
         ...
         <div class="col-12 justify-content-center py-5">
            <div class="m-5">
               <img src="{{ asset('/assets/logo.png') }}" class="rounded mx-auto d-block" style="height: 120px" alt="">
            </div>
            ...
            @elseif (session()->has('status_bad'))
            <div class="alert alert-danger d-flex align-items-center" role="alert">
               <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Danger:">
                  <use xlink:href="#exclamation-triangle-fill" />
               </svg>
               <div>
                  {{ session()->get('status_bad') }}
               </div>
            </div>
